...
*/
router.route('/').get(games.list).post(games.create);


/*
	The ':' specifies a URL parameter.
*/
router.route('/:gameId').get(games.read).put(games.update).delete(games.delete);
...
router.param('gameId', games.listingByID);
